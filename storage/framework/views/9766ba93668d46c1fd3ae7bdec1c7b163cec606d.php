<?php $__env->startSection('htmlheader_title'); ?>
   Factura Ocassional : <?php echo e(str_pad($invoices->number, 3, "0", STR_PAD_LEFT)); ?>
...
<?php $__env->startSection('main-content'); ?>
   ...
   <?php if(isset($invoices->stateSend) and $invoices->stateSend == 'Pago Realizado' and Auth::user()->role != 'Administrador'): ?>
   ...
   <?php if(isset($invoices->statePayment) and $invoices->statePayment == 'Pago Realizado' and Auth::user()->role != 'Cliente'): ?>
      <div class="panel panel" style="color:rgb(17, 103, 44)">
         <div class="panel-heading bg-success">
            <h4>
               <?php echo e($invoices->customer->name); ?> a Confirmado el Pago de la Factura: <?php echo e($invoices->invoiceperiod); ?></h4>
   ...
   <div class="panel panel-default">
      <div class="panel-heading" style="height:60px">
         ...
         <div class="pull-right" style="font-size:18px">
            ...
            <?php if(Auth::user()->role == 'Cliente' and $invoices->stateSend = 'Pago Realizado'): ?>
