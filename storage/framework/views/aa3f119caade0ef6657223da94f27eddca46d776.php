...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title><?php echo e('Factura:_'.$invoices->nameCustomer.'_Nro_'.$invoices->number.'_Periodo_'.$invoices->invoiceperiod); ?></title>
            ...
            <td class="service">
               <table style="margin-left:100px">
                  ...
                  <tr>
                     ...
                     mes:<?php echo e($invoices->invoiceperiod); ?>
           ...
           <?php $__currentLoopData = $invoiceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <tr>
                 ...
                 <td style="border: 1px solid black;" lass="qty" width="30%"><?php echo e($id->description); ?></td>
                    ...
                    <?php else: ?>
                       <td class="unit" style="border: 1px solid black;"><?php echo e($id->payment); ?> x <?php echo e($invoices->months); ?> Mes(es)</td>
                    <?php endif; ?>
                     <?php if($id->type == 'Descuento' or $id->type == 'Adicional'): ?>
                        <td style="border: 1px solid black;" class="unit" style="border: 1px solid black;"><?php echo e($id->payment); ?> </td>
                     <?php else: ?>
                       <td style="border: 1px solid black;"><?php echo e($id->payment * $invoices->months); ?></td>
                     <?php endif; ?>
