...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>{{'Factura:_'.$invoices->nameCustomer.'_Nro_'.$invoices->number}}</title>
...
<html lang="en">
  ...
  <body>
     <img src="{{asset('img/logo.png')}}" alt="icono">
    <header class="">
      <div class="" style="text-align:center">
         <h1>Eje Satelital</h1>
            ...
            <td class="service">
               <table style="margin-top:-100px;margin-left:160px">
                  ...
                  <tr>
                     ...
                     <th style="color:red"><strong>{{\Carbon\Carbon::parse($invoices->paymentTimely)->format('d-m-Y')}}</strong></th>
                  </tr>
                  <tr>
        ...
        <tbody>
           @foreach ($invoiceDetails as $id)
             <tr>
                 ...
                 <td style="border: 1px solid black;" class="">{{$id->type}}</td>
                 <td style="border: 1px solid black;" lass="qty" width="30%">{{$id->description}}</td>
                 <td style="border: 1px solid black;" class="total">{{$id->payment}}</td>
             </tr>
           @endforeach
           <tr>
             <td colspan="2" style='border: inset 0pt;border-collapse:inherit'></td>
