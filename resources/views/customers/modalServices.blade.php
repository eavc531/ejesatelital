  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary"href="{{route('invoiceOccasionalPreview',$customer->id)}}">Aceptar</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
         ...
         <a href="{{route('confirmCreateInvoice')}}" class="btn btn-primary">Aceptar</a>
         <a href="{{route('cancelCreateInvoice')}}" class="btn btn-default">Cancelar</a>
      </div>
    </div>
  </div>
</div>
