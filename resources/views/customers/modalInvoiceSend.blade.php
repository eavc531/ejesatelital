      ...
      <div class="modal-body">
         ...
         <div class="form-group">
            <label for=""><strong>Correo:</strong></label>
             {!!Form::select('email',[$invoices->customer->email=>$invoices->customer->email,$invoices->customer->email2=>$invoices->customer->email2],$invoices->customer->email,['class'=>'form-control','id'=>'email' ])!!}
             <label for="numberPhone"><strong>Numero teléfonico:</strong></label>
            {!!Form::select('numberPhone',[$customer->phone1 =>$customer->phone1,$customer->phone2=>$customer->phone2],$customer->phone1,['class'=>'form-control','id'=>'numberPhone2'])!!}
         </div>
         <div class="form-group">
         ...
         <div class="form-group" style="padding:10px">
            ...
            {!!Form::hidden('invoice_id',$invoices->id,['id'=>'invoice_id'])!!}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header"style="color:white;background:rgb(27, 97, 191)">
        <h4 class="modal-title" id="exampleModalLabel">Enviar Notificación a: <strong> {{$invoices->nameCustomer}}</strong></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <div class="form-inline">
            <label for="numberPhone"><strong>Numero teléfonico:</strong></label>
            {!!Form::select('numberPhone',[$customer->phone1 =>$customer->phone1,$customer->phone2=>$customer->phone2],null,['class'=>'form-control','style'=>'width:120px;margin-left:20px;','id'=>'numberPhone3'])!!}
         </div>
         <input type="hidden" name="" value="{{$paymentTimely = \Carbon\Carbon::parse($invoices->paymentTimely)->format('d-m-Y')}}">
         <label for="" style="margin-top:20px"><strong>Mensaje:</strong></label>
         {!!Form::textarea('message','Su factura Eje Satelital se envio a su email principal por valor de '.$invoices->total.' Fecha de Pago Oportuno antes de: '.$paymentTimely,['class'=>'form-control','style'=>'height:100px','id'=>'message3'])!!}
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header"style="color:white;background:rgb(233, 182, 51)">
        <h4 class="modal-title" id="exampleModalLabel">Enviar recordatorio a: <strong> {{$invoices->nameCustomer}}</strong></h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
         <div class="form-inline">
            <label for="numberPhone"><strong>Numero teléfonico:</strong></label>
            {!!Form::select('numberPhone',[$customer->phone1 =>$customer->phone1,$customer->phone2=>$customer->phone2],null,['class'=>'form-control','style'=>'width:120px;margin-left:20px;','id'=>'numberPhone'])!!}
         </div>
         <label for="" style="margin-top:20px"><strong>Mensaje:</strong></label>
         {!!Form::textarea('message','Apreciado usuario de Eje Satelital, nuestro sistema no registra su pago del mes en curso, cancele hoy en cualquiera de nuestros canales autorizados.',['class'=>'form-control','style'=>'height:100px','id'=>'message'])!!}
      </div>
      <div class="modal-footer">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
         <div class="form-inline">
            <label for="numberPhone"><strong>Numero teléfonico:</strong></label>
            {!!Form::select('numberPhone',[$customer->phone1 =>$customer->phone1,$customer->phone2=>$customer->phone2],null,['class'=>'form-control','style'=>'width:120px;margin-left:20px;','id'=>'numberPhone4'])!!}
         </div>
         <label for="" style="margin-top:20px"><strong>Mensaje:</strong></label>
         {!!Form::textarea('message','AVISO DE SUSPENSION: Estimado usuario, su servicio con Eje Satelital se encuentra en mora, recuerde pagar sus facturas a tiempo y evite desconexiones.
