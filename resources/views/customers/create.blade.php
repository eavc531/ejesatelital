         ...
         <div class="row">
            <div class="form-group col-sm-6">
               <div class="form-group">
                  ...
                  {!!Form::text('idNumber',null,['class'=>'form-control','placeholder'=>'Ingrese el Numero de Cédula', 'style'=>'-webkit-border-radius: 8px;-moz-border-radius: 8px;border-radius: 8px;'])!!}
               </div>
            ...
            <div class="form-group col-sm-6">
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     {!!Form::password('password',['class'=>'form-control','placeholder'=>'Ingrese una Contraseña para el Cliente', 'style'=>'-webkit-border-radius: 8px;-moz-border-radius: 8px;border-radius: 8px;'])!!}
                  </div>
            ...
            <div style="margin-top:-40px" class="form-group col-sm-12">
               ...
               <a style=""class="btn btn-default" href="{{route('customers.index')}}"><strong>Cancelar</strong>
               </a>
            </div>
      {!!Form::close()!!}
